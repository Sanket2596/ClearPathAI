...
try:
    ...
    print("✅ Package Service database tables created successfully!")
except Exception as e:
    print(f"❌ Package Service database setup failed: {e}")
...
async def lifespan(app: FastAPI):
    # Startup
    print("🚀 Package Service starting up...")
    yield
    # Shutdown
    print("🛑 Package Service shutting down...")

app = FastAPI(
    title="Package Management Service",
    description="Handles package CRUD operations, tracking, and analytics",
    version="1.0.0",
    lifespan=lifespan
)
...
async def root():
    return {
        "message": "Package Management Service",
        "version": "1.0.0",
        "status": "operational"
    }
